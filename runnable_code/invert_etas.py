...
if __name__ == '__main__':
  ...
  '''
    ...
    WHEN RUNNING ETAS INVERSION WITH VARYING MC:
            ...
            '../config/invert_etas_mc_var_config.json', the catalog stored in
            "fn_catalog" needs to have such a column "mc_current" (example
            described below), and a reference magnitude "m_ref" needs to be
            provided. this can, but does not have to be the minimum mc_current.
