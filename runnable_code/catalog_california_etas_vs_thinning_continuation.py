#!/usr/bin/env python3
"""
Catalog-driven California continuation: classic ETAS vs Ogata branching thinning.

CLI port of ``notebooks/catalog_california_etas_vs_thinning_continuation.ipynb``.
...
Usage::
  ...
  python runnable_code/catalog_california_etas_vs_thinning_continuation.py
