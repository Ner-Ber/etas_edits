...
if __name__ == '__main__':
  ...
  with open('./config/jma_forecast_config.json', 'r') as f:
    forecast_config = json.load(f)
  etas_invert = etas_inversion.ETASParameterCalculation(forecast_config)
  etas_invert.prepare()
  ...
  simulation = etas_simulation.ETASSimulation(etas_invert, m_max=m_max)
  simulation.prepare()
